...
int main(int argc, char* argv[]) {
	...
	float sgmTau0=1.0E-5;  ///4th param 0.25 / 0.50 / 1 / 2 / 4  
	float kappa0=100.;
	float eta_inf=5.0E-6;/// 5th param 0.25 / 0.50 / 1 / 2 / 4 
	//
	//
    //
...
//////////////////////////////////////////////////////////
    std::cout<<"\n 1. phase: remove particles above the cone height\n"<<std::endl;	
...
//////////////////////////////////////////////////////////
	// 3. phase: remove containers and allow flow
//////////////////////////////////////////////////////////
	std::cout<<"\n 3. phase: flow  \n"<<std::endl;
	//
