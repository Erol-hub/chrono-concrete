...
#ifndef CHRANDOMSHAPECREATOR_SMC_H
#define CHRANDOMSHAPECREATOR_SMC_H
...
class ChRandomShapeCreatorSpheres : public ChRandomShapeCreator {
  public:
	...
	/// Set the material 
	void SetMaterial(std::shared_ptr<ChMaterialSurfaceSMC> mymaterial) { material = mymaterial; }
	
	/// Get the material 
	std::shared_ptr<ChMaterialSurfaceSMC> GetMaterial() { return material; }
