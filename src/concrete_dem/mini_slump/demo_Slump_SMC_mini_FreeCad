...
//#include "/FC_code/mycontact_V2_2.cpp" mycontact_V2_2_floc.cpp
...
std::shared_ptr<ChBody> AddConicalContainer(ChSystem& sys, std::shared_ptr<ChMaterialSurface> mat, double density, double radius, double height, std::string current_dir) {
	...
	cylinder->SetPos(ChVector<>(0,27,0));
...
std::shared_ptr<ChBody> AddConicalContainer2(ChSystem& sys, std::shared_ptr<ChMaterialSurface> mat, double density, double radius, double height, std::string current_dir) {
	...
	cylinder->SetRot(q);	
	cylinder->SetPos(ChVector<>(0,(50.8-27)+50.8,0));
	cylinder->SetBodyFixed(true);	
    sys.AddBody(cylinder); 
    return cylinder;	
...
void AddFallingItems(ChSystem& sys, std::shared_ptr<ChVisualSystemIrrlicht>& vis, std::string& data_path, std::string& file_name, double rho, double h_layer) {
    ...
    if (radiusFile.is_open()) {       	
		...
		while (std::getline(radiusFile, line)) {			
			...
			if( line[0]!='#') {				
				std::istringstream sline(line);
				sline>> rad;
				body_radius.push_back(rad+h_layer*0/2); 
			}
		}
    }
    else{
    ...
    for (i=0; i<numSpheres; i++) {
        ...
        //if ((y_pos>40 || y_pos<-30) || (x_pos*x_pos+z_pos*z_pos)>35.*35.)
		//	continue;
...
/////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    //emitter.MassReservoirAmount() = targetmass;
    ...
    mcreator_spheres->SetXsizeDistribution(
        chrono_types::make_shared<ChZhangDistribution>(0.5, 0.2));  // Zhang parameters: average val, min val.
    mcreator_spheres->SetSizeRatioZDistribution(chrono_types::make_shared<ChMinMaxDistribution>(0.2, 1.0));
    mcreator_spheres->SetSizeRatioYZDistribution(chrono_types::make_shared<ChMinMaxDistribution>(0.4, 1.0));
    mcreator_spheres->SetDensityDistribution(chrono_types::make_shared<ChConstantDistribution>(1000));*/
    ...
    //remover.SetBox(ChVector<>(102, 240, 102), ChFrame<>(ChVector<>(0,50,0), QUNIT));
...
/////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	int step_num=0;
	char filename[200];
	const std::string out_dir = current_dir + "/OUT_Mini_FreeCad_h2_E1p5e-2_S5e-4_T2e-5_V2e-5_con1e-5/";
...
/////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	// FILLING ////////
	//
    std::cout<<"\n 1. phase: Filling the container\n"<<std::endl;	
/////////////////////////////////////////////////////////////////////////////////////////////////////	
    while (   sys.GetChTime()<-0.40) {
		//vis->Run() &
...
/////////////////////////////////////////////////////////////////////////////////////////////////////	
   ...
   //
    std::cout<<"\n 2. phase: remove particles above the cone height\n"<<std::endl;	
//////////////////////////////////////////////////////////
		...
		// 
		 if (std::fmod(step_num, 800) ==0) {
		    ...
		    std::cout<< "filename: "<<filename<<"\t";
		     ...
		     //fprintf(fptr, "%10.6f\t", topPlate->GetPos().y());
		     //fprintf(fptr, "\n");
