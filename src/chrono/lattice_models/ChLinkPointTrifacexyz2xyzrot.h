...
// Authors: Erol Lale
// =============================================================================
// Class for ChNodeFeaXYZrot type nodes to surface (defined by node without rotational dof.) constraint :  
//
//  This constrain can be used when one needs constraint between LDPM nodes and conventional FEM surface
//  
//  
// =============================================================================
...
class ChTriangleOfXYZNodes : public ChVariableTupleCarrier_3vars<3, 3, 3> {
  public:
...
class ChLinkPointTrifacexyz2xyzrot : public ChLinkBase {
  private:
    ChVector<> react;

    // used as an interface to the solver.
    ChConstraintTwoTuples<ChNodeFEAxyzrot, ChTriangleOfXYZNodes> constraint1;
    ChConstraintTwoTuples<ChNodeFEAxyzrot, ChTriangleOfXYZNodes> constraint2;
    ChConstraintTwoTuples<ChNodeFEAxyzrot, ChTriangleOfXYZNodes> constraint3;
  ...
  public:
    ChLinkPointTrifacexyz2xyzrot();
    ChLinkPointTrifacexyz2xyzrot(const ChLinkPointTrifacexyz2xyzrot& other);
    ~ChLinkPointTrifacexyz2xyzrot() {}

    /// "Virtual" copy constructor (covariant return type).
    virtual ChLinkPointTrifacexyz2xyzrot* Clone() const override { return new ChLinkPointTrifacexyz2xyzrot(*this); }
...
/// Utility class for using the ChLinkPointTriface constraint
class ChTriangleOfXYZROTnodes : public ChVariableTupleCarrier_3vars<6, 6, 6> {
  public:
...
/// shape function (ex. the face of a tetrahedron or a triangular shell)
/// The node can be offset respect to the face.
class ChLinkPointTrifacexyzrot2xyzrot : public ChLinkBase {
  private:
    ChVector<> react;
  ...
  public:
    ChLinkPointTrifacexyzrot2xyzrot();
    ChLinkPointTrifacexyzrot2xyzrot(const ChLinkPointTrifacexyzrot2xyzrot& other);
    ~ChLinkPointTrifacexyzrot2xyzrot() {}

    /// "Virtual" copy constructor (covariant return type).
    virtual ChLinkPointTrifacexyzrot2xyzrot* Clone() const override { return new ChLinkPointTrifacexyzrot2xyzrot(*this); }

    /// Get the number of scalar variables affected by constraints in this link
    virtual int GetNumCoords() override { return 6 + 6 + 6 + 6; }
